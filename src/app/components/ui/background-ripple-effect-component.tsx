...
export function BackgroundRippleEffect() {
  return (
    <div className="relative flex min-h-screen w-full flex-col items-center justify-start overflow-hidden px-4 sm:px-6 lg:px-8">
      ...
      <div className="mt-40 md:mt-60 w-full max-w-6xl mx-auto flex flex-col gap-8 md:gap-12">
        <div className="flex flex-col text-center md:text-left">
          <h2 className="relative z-10 text-3xl sm:text-4xl md:text-5xl font-bold text-white">
            Frances Khem Andre Donaire
          </h2>
          <h4 className="relative z-10 mt-4 text-xl sm:text-2xl md:text-3xl text-blue-300">
        ...
        <div className="self-end w-full md:w-4/5 lg:w-3/4">
          <p className="relative z-10 text-lg md:text-xl text-white text-justify opacity-90">
